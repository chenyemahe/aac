...
public class AAProvider extends ContentProvider {
    ...
    // Amazon Transaction Record
    public interface TransColumns extends BaseColumns {
        String TBL_TRANS_PROFILES = "aa_trans_order";
        ...
        String shipping_credits = "shipping_credits";
        String gift_wrap_credits = "gift_wrap_credits";
        String promotional_rebates = "promotional_rebates";
        String sales_tax_collected = "sales_tax_collected";
        String selling_fees = "selling_fees";
        String fba_fees = "fba_fees";
        String other_transaction_fees = "other_transaction_fees";
        String other = "other";
        String total = "total";
    }
    ...
    public static class AADatabaseHelper extends SQLiteOpenHelper {
        ...
        public void onCreate(SQLiteDatabase db) {
            ...
            db.execSQL("CREATE TABLE " + TransColumns.TBL_TRANS_PROFILES + " ("
                    + TransColumns._ID + " INTEGER PRIMARY KEY AUTOINCREMENT, "
                    + TransColumns.aa_tran_date + " VARCHAR, "
                    + TransColumns.settlement_id + " VARCHAR, "
                    + TransColumns.aa_type + " VARCHAR, "
                    + TransColumns.order_id + " VARCHAR, "
                    ...
                    + TransColumns.order_postal + " VARCHAR, "
                    + TransColumns.product_sales + " VARCHAR, "
                    + TransColumns.shipping_credits + " VARCHAR, "
                    + TransColumns.gift_wrap_credits + " VARCHAR, "
                    + TransColumns.promotional_rebates + " VARCHAR, "
                    + TransColumns.sales_tax_collected + " VARCHAR, "
                    + TransColumns.selling_fees + " VARCHAR, "
                    + TransColumns.fba_fees + " VARCHAR, "
                    + TransColumns.other_transaction_fees + " VARCHAR, "
                    + TransColumns.other + " VARCHAR, "
                    + TransColumns.total + " VARCHAR);");
        }
